...
| `fail_mode` | `open` | SIXTA unreachable → `open`: warn & pass; `closed`: fail. Findings always gate. A rejected API key (HTTP 401/403) always fails in CI, regardless of mode; local pre-commit runs warn and proceed. |
